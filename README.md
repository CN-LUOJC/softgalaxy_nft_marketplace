<div align="center">
<h1 align="center">🌌 Galaxy – Responsive eCommerce NFT Website Template</h1>
Galaxy is a fully responsive eCommerce NFT website template, designed to work seamlessly on all devices. Built with HTML, CSS, JavaScript, Bootstrap 5, and React + Vite, this template is optimized for performance, scalability, and a modern UI/UX.
<br />
</div>
...
```bash
git clone https://github.com/hotcappuccino9230/Galaxy.git
cd Galaxy
npm run install:all
npm start
```
